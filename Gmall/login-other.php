...
<div class="container SignIn ptonav">
  ...
  <div class="col-md-10 col-md-offset-1">
    <div class="line-b pb40 mt20 text-center">
        <h1 class="font"><b>常用账号登陆</b></h1>
        <p class="h3 mt20">快来加入我们吧，您也可以重新<a href="" class="hover">注册账号</a></p>
      </div>      <div class="col-sm-8 col-sm-offset-4">
        <form class="form-horizontal mt40" role="form">
          <div class="form-group">
            <div class="col-xs-10 col-sm-6">
              <input type="text" class="form-control error"  placeholder="账户/手机号/邮箱" >
            </div>
            <div class="col-xs-12 col-sm-6 col-md-5"> <span class="tips error-tips">*用户名不正确</span> </div>
          </div>
          <!--form-group -->
          <div class="form-group">
            <div class="col-xs-10 col-sm-6">
            ...
            <div class="col-xs-12 col-sm-6"> <span class="tips error-tips">*密码不正确</span> </div>
          </div>
          <!--form-group -->
          <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-7"> <span class="form-Yzmimg"><a href="#"><img src="img/Yzm.jpg" height="34" align="absmiddle"></a><span class="font18">点击图片刷新验证码</span></span> </div>
          </div>
          <!--form-group -->
